...
class MuseGAN():
    ...
    def BarGenerator(self):
        ...
        x = self.conv_t(x, f=256, k=(4,1), s=(4,1), a= 'relu', p = 'same', bn = True)
    ...
    def binarise_output(self, output):
        ...
        # TODO : use a threshold like in the original paper so each track can contain multiple notes instead of only the maximum pitch in the current model.
